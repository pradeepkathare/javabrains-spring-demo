...
@Component
public class CollegePublishEvent implements University {
	...
	public CollegePublishEvent() {
		System.out.println("default constructor");
	}
	public CollegePublishEvent(Student student ,Address studentAddress,Address collegeAddress) {
	...
	public void collegeDetails() {
		...
		printMessageSource();
		System.out.println();
		System.out.println("Publish my custom event");
		C23_CustomEvent event = new C23_CustomEvent(this);
