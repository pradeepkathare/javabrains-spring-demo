...
@Component
public class CollegeComponentAnnotation implements University {

	Student student;
	Address studentAddress;
	Address collegeAddress;
		
	public CollegeComponentAnnotation() {
		System.out.println("default constructor");
	}
	public CollegeComponentAnnotation(Student student ,Address studentAddress,Address collegeAddress) {
